...
castlebits are started at 1,2,4,8 (check defs)
0001 - WKCA
0010 - WQCA
0100 - BKCA
1000 - BQCA

1101 = white can castle kingside and black can castle either side
0101 = black was blocked on queen side, both can only castle king side

This allowed bitwise operations i.e. if(1101 & WKCA) != 0 then we know white can castle king side
*/

/*
WHY HAVE A PIECE LIST?

If we don't we have to do a lot of unnecesarry checking

loop through pieces
if theres a piece on the square and the piece is on the side of the mover, then generate those moves

If we have a piece list
squareOfPiece = Plist[index];
we can store our pieces in such a way we can get the index without having to check anything
*/
